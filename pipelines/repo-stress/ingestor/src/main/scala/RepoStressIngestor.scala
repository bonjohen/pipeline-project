...
object RepoStressIngestor {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val startDate = endDate.minusDays(60) // Get more history for rolling averages

    println(s"Fetching repo market stress data from FRED...")
